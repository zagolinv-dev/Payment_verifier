...
abstract class AuthRepository {
  ...
  Future<UserProfileEntity> signUp({required String email, required String password, String? fullName, String? phone, String? ownerName, String? address, String? description});
  Future<void> signOut();
